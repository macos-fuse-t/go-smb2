...
func (r CreateContextDecoder) Next() uint32 {
	return le.Uint32(r[:4])
}

func (r CreateContextDecoder) NameOffset() uint16 {
	return le.Uint16(r[4:])
}

func (r CreateContextDecoder) NameLength() uint16 {
	return le.Uint16(r[6:])
}

func (r CreateContextDecoder) DataOffset() uint16 {
	return le.Uint16(r[10:])
}

func (r CreateContextDecoder) DataLength() uint32 {
	return le.Uint32(r[12:])
}
...
func (r IoctlRequestDecoder) Data() []byte {
	return r[56:]
}
...
func (r SetInfoRequestDecoder) Buffer() []byte {
	return r[32:]
}
...
type AAPLServerQueryRequest struct {
	CommandCode   uint32
	Reserved      uint32
...
type AAPLServerQueryRequestDecoder []byte

func (r AAPLServerQueryRequestDecoder) CommandCode() uint32 {
	return le.Uint32(r[0:])
}

func (r AAPLServerQueryRequestDecoder) RequestBitmap() uint64 {
	return le.Uint64(r[8:])
}

func (r AAPLServerQueryRequestDecoder) ClientCaps() uint64 {
	return le.Uint64(r[16:])
}
...
type DurableHandleRequest2 struct {
	Timeout    uint32
	Flags      uint32
	CreateGuid [16]byte
}

type DurableHandleRequest2Decoder []byte

func (r DurableHandleRequest2Decoder) Timeout() uint32 {
	return le.Uint32(r[0:])
}

func (r DurableHandleRequest2Decoder) Flags() uint32 {
	return le.Uint32(r[4:])
}

func (r DurableHandleRequest2Decoder) CreateGuid() []byte {
	return r[16:32]
}
...
type LeaseRequestDecoder []byte

func (r LeaseRequestDecoder) LeaseKey() Guid {
	var guid Guid
	copy(guid[:], r[:])
	return guid
}

func (r LeaseRequestDecoder) LeaseState() uint32 {
	return le.Uint32(r[16:])
}

func (r LeaseRequestDecoder) LeaseFlags() uint32 {
	return le.Uint32(r[20:])
}

func (r LeaseRequestDecoder) LeaseDuration() uint64 {
	return le.Uint64(r[24:])
}
...
type LeaseRequest2Decoder []byte

func (r LeaseRequest2Decoder) LeaseKey() Guid {
	var guid Guid
	copy(guid[:], r[:])
	return guid
}

func (r LeaseRequest2Decoder) LeaseState() uint32 {
	return le.Uint32(r[16:])
}

func (r LeaseRequest2Decoder) LeaseFlags() uint32 {
	return le.Uint32(r[20:])
}

func (r LeaseRequest2Decoder) LeaseDuration() uint64 {
	return le.Uint64(r[24:])
}

func (r LeaseRequest2Decoder) ParentLeaseKey() Guid {
	var guid Guid
	copy(guid[:], r[32:48])
	return guid
}

func (r LeaseRequest2Decoder) Epoch() uint16 {
	return le.Uint16(r[48:])
}
